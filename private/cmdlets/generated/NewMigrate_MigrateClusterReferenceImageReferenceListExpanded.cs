namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-Migrate.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Migrate_MigrateClusterReferenceImageReferenceListExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    public class NewMigrate_MigrateClusterReferenceImageReferenceListExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IImageMigrateInput _bodyBody= new Nutanix.Powershell.Models.ImageMigrateInput();

        /// <summary>
        /// Specify the cluster and image(s) from the cluster to migrate to PC
        /// </summary>
        private Nutanix.Powershell.Models.IImageMigrateInput BodyBody
        {
            get
            {
        ...
        public string ClusterReferenceUuid
        {
            set
            {
                BodyBody.ClusterReference = BodyBody.ClusterReference ?? new Nutanix.Powershell.Models.ClusterReference();
                BodyBody.ClusterReference.Uuid = value;
            }
        }
        ...
        public Nutanix.Powershell.Models.IImageReference[] ImageReferenceList
        {
            set
            {
                BodyBody.ImageReferenceList = value;
            }
        }
        /// <summary>
        ...
        /// <returns>
        /// a duplicate instance of NewMigrate_MigrateClusterReferenceImageReferenceListExpanded
        /// </returns>
        public Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceListExpanded Clone()
        {
        ...
        /// <returns>an instance of NewMigrate_MigrateClusterReferenceImageReferenceListExpanded.</returns>
        public static Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceListExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewMigrate_MigrateClusterReferenceImageReferenceListExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewMigrate_MigrateClusterReferenceImageReferenceListExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceListExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewMigrate_MigrateClusterReferenceImageReferenceListExpanded" /> cmdlet class.
        /// </summary>
        public NewMigrate_MigrateClusterReferenceImageReferenceListExpanded()
        {
        }
        ...
        internal NewMigrate_MigrateClusterReferenceImageReferenceListExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _bodyBody = If( json?.PropertyT<Carbon.Json.JsonObject>("BodyBody"), out var __jsonBodyBody) ? Nutanix.Powershell.Models.ImageMigrateInput.FromJson(__jsonBodyBody) : BodyBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NewMigrate' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NewMigrate(BodyBody, onAccepted, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewMigrate_MigrateClusterReferenceImageReferenceListExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.IProceduralResponse" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onAccepted(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.IProceduralResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onAccepted - response for 202 / application/json
                // response should be returning an array of some kind. +Pageable
                // nested-array / message_list / <none>
                // (await response) // should be Nutanix.Powershell.Models.IProceduralResponse
                WriteObject((await response).TaskUuid);
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.IProceduralErrorResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.IProceduralErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
