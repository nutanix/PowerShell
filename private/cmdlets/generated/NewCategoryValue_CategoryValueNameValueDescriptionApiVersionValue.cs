namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"CategoryValue_CategoryValueNameValueDescriptionApiVersionValue", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryValueStatus))]
    public class NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ICategoryValue _spec;

        /// <summary>Category value definition.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Category value definition.", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.ICategoryValue Spec
        {
            get
            {
                return this._spec;
        ...
        /// <returns>
        /// a duplicate instance of NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue
        /// </returns>
        public Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue Clone()
        {
        ...
        /// <returns>
        /// an instance of NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue" /> cmdlet
        /// class.
        /// </summary>
        public NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue()
        {
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.CreateCategoryValue(Name, Value, Spec, onOK, onCreated, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValue" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Name,Value,Spec}));
            }
        }
