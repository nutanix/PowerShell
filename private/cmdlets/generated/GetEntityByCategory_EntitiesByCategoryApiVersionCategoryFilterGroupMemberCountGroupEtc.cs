namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"EntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryQueryResponse))]
    public class GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ICategoryQueryInput _query;

        /// <summary>Categories query input object.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Categories query input object.", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.ICategoryQueryInput Query
        {
            get
            {
                return this._query;
        ...
        /// <returns>
        /// a duplicate instance of GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc"
        /// /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc"
        /// /> cmdlet class.
        /// </summary>
        public GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc()
        {
        }
        ...
        internal GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _query = If( json?.PropertyT<Carbon.Json.JsonObject>("Query"), out var __jsonQuery) ? Nutanix.Powershell.Models.CategoryQueryInput.FromJson(__jsonQuery) : Query;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.ListEntitiesByCategory(Query, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtc"
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != Query ? (Carbon.Json.JsonNode) Query.ToJson(null) : null, "Query" ,container.Add );
            return container;
        }
        /// <summary>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Query}));
            }
        }
