namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Migrate_MigrateClusterReferenceImageReferenceList", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    public class NewMigrate_MigrateClusterReferenceImageReferenceList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IImageMigrateInput _body;

        /// <summary>
        /// Specify the cluster and image(s) from the cluster to migrate to PC
        /// </summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Specify the cluster and image(s) from the cluster to migrate to PC\n", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.IImageMigrateInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>a duplicate instance of NewMigrate_MigrateClusterReferenceImageReferenceList</returns>
        public Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceList Clone()
        {
        ...
        /// <returns>an instance of NewMigrate_MigrateClusterReferenceImageReferenceList.</returns>
        public static Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewMigrate_MigrateClusterReferenceImageReferenceList(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewMigrate_MigrateClusterReferenceImageReferenceList" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewMigrate_MigrateClusterReferenceImageReferenceList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewMigrate_MigrateClusterReferenceImageReferenceList" /> cmdlet class.
        /// </summary>
        public NewMigrate_MigrateClusterReferenceImageReferenceList()
        {
        }
        ...
        internal NewMigrate_MigrateClusterReferenceImageReferenceList(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Nutanix.Powershell.Models.ImageMigrateInput.FromJson(__jsonBody) : Body;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NewMigrate(Body, onAccepted, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewMigrate_MigrateClusterReferenceImageReferenceList" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
