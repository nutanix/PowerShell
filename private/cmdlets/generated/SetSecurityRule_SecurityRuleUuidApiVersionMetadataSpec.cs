namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"SecurityRule_SecurityRuleUuidApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleIntentResponse))]
    public class SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec</returns>
        public Nutanix.Powershell.Cmdlets.SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec.</returns>
        public static Nutanix.Powershell.Cmdlets.SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec()
        {
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetSecurityRule_SecurityRuleUuidApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
