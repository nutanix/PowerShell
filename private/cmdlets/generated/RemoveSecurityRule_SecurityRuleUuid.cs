namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-SecurityRule.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"SecurityRule_SecurityRuleUuid", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleIntentResponse))]
    public class RemoveSecurityRule_SecurityRuleUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveSecurityRule_SecurityRuleUuid</returns>
        public Nutanix.Powershell.Cmdlets.RemoveSecurityRule_SecurityRuleUuid Clone()
        {
        ...
        /// <returns>an instance of RemoveSecurityRule_SecurityRuleUuid.</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveSecurityRule_SecurityRuleUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveSecurityRule_SecurityRuleUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveSecurityRule_SecurityRuleUuid" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.RemoveSecurityRule_SecurityRuleUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'deleteSecurityRule' operation"))
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveSecurityRule_SecurityRuleUuid" /> cmdlet class.
        /// </summary>
        public RemoveSecurityRule_SecurityRuleUuid()
        {
        }
        ...
        internal RemoveSecurityRule_SecurityRuleUuid(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveSecurityRule_SecurityRuleUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
