namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"TaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITaskListIntentResponse))]
    public class GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ITaskListMetadata _getEntitiesRequest;
        ...
        public Nutanix.Powershell.Models.ITaskListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        /// <returns>
        /// an instance of GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet
        /// class.
        /// </summary>
        public GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder()
        {
        }
        ...
        internal GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Nutanix.Powershell.Models.TaskListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GetTaskList' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetTaskList(GetEntitiesRequest, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetTaskList_TaskListFilterKindLengthOffsetSortAttributeSortOrder" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
