namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-CategoryKey.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"CategoryKey_CategoryKeyName", SupportsShouldProcess = true)]
    public class RemoveCategoryKey_CategoryKeyName : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveCategoryKey_CategoryKeyName</returns>
        public Nutanix.Powershell.Cmdlets.RemoveCategoryKey_CategoryKeyName Clone()
        {
        ...
        /// <returns>an instance of RemoveCategoryKey_CategoryKeyName.</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveCategoryKey_CategoryKeyName FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveCategoryKey_CategoryKeyName(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveCategoryKey_CategoryKeyName" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.RemoveCategoryKey_CategoryKeyName FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'deleteCategoryKey' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.DeleteCategoryKey(Name, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveCategoryKey_CategoryKeyName" /> cmdlet class.
        /// </summary>
        public RemoveCategoryKey_CategoryKeyName()
        {
        }
        ...
        internal RemoveCategoryKey_CategoryKeyName(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveCategoryKey_CategoryKeyName" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
