namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-CategoryKey.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"CategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryKeyStatus))]
    public class NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ICategoryKey _specBody= new Nutanix.Powershell.Models.CategoryKey();

        /// <summary>Category key definition.</summary>
        private Nutanix.Powershell.Models.ICategoryKey SpecBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded
        /// </returns>
        public Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded Clone()
        {
        ...
        /// <returns>an instance of NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded.</returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded()
        {
        }
        ...
        internal NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _name = If( json?.PropertyT<Carbon.Json.JsonString>("Name"), out var __jsonName) ? (string)__jsonName : (string)Name;
            _specBody = If( json?.PropertyT<Carbon.Json.JsonObject>("SpecBody"), out var __jsonSpecBody) ? Nutanix.Powershell.Models.CategoryKey.FromJson(__jsonSpecBody) : SpecBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'createCategoryKey' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.CreateCategoryKey(Name, SpecBody, onOK, onCreated, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersionExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onCreated(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryKeyStatus> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Name,SpecBody}));
            }
        }
