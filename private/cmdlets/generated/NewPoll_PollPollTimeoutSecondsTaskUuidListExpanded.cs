namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-Poll.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Poll_PollPollTimeoutSecondsTaskUuidListExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITaskPollResponse))]
    public class NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ITaskPollInput _bodyBody= new Nutanix.Powershell.Models.TaskPollInput();

        /// <summary>Input for a task poll</summary>
        private Nutanix.Powershell.Models.ITaskPollInput BodyBody
        {
            get
            {
        ...
        public int PollTimeoutSeconds
        {
            set
            {
                BodyBody.PollTimeoutSeconds = value;
            }
        }
        ...
        /// <returns>a duplicate instance of NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded</returns>
        public Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded Clone()
        {
        ...
        /// <returns>an instance of NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded.</returns>
        public static Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded" /> cmdlet class.
        /// </summary>
        public NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded()
        {
        }
        ...
        internal NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _bodyBody = If( json?.PropertyT<Carbon.Json.JsonObject>("BodyBody"), out var __jsonBodyBody) ? Nutanix.Powershell.Models.TaskPollInput.FromJson(__jsonBodyBody) : BodyBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NewPoll' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NewPoll(BodyBody, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidListExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.ITaskPollResponse" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ITaskPollResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Nutanix.Powershell.Models.ITaskPollResponse
