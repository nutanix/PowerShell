namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-CategoryValue.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"CategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryValueStatus))]
    public class NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="SpecBody" /> property.</summary>
        private Nutanix.Powershell.Models.ICategoryValue _specBody= new Nutanix.Powershell.Models.CategoryValue();

        /// <summary>Category value definition.</summary>
        private Nutanix.Powershell.Models.ICategoryValue SpecBody
        {
            get
            {
                return this._specBody;
            }
            set
            {
                this._specBody = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded
        /// </returns>
        public Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded" />
        /// cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded()
        {
        }
        ...
        internal NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded(Carbon.Json.JsonObject json)
        {
            ...
            _specBody = If( json?.PropertyT<Carbon.Json.JsonObject>("SpecBody"), out var __jsonSpecBody) ? Nutanix.Powershell.Models.CategoryValue.FromJson(__jsonSpecBody) : SpecBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'createCategoryValue' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.CreateCategoryValue(Name, Value, SpecBody, onOK, onCreated, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewCategoryValue_CategoryValueNameValueDescriptionApiVersionValueExpanded" /> as a
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != Value ? (Carbon.Json.JsonNode) new Carbon.Json.JsonString(Value) : null, "Value" ,container.Add );
            AddIf( null != SpecBody ? (Carbon.Json.JsonNode) SpecBody.ToJson(null) : null, "SpecBody" ,container.Add );
            return container;
        }
        /// <summary>a delegate that is called when the remote service returns 201 (Created).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.ICategoryValueStatus" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onCreated(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryValueStatus> response)
        {
            using( NoSynchronizationContext )
            {
                // onCreated - response for 201 / application/json
                // (await response) // should be Nutanix.Powershell.Models.ICategoryValueStatus
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Name,Value,SpecBody}));
            }
        }
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryValueStatus> response)
        {
            using( NoSynchronizationContext )
            {
