namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"CategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryValueListResponse))]
    public class GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ICategoryListMetadata _getEntitiesRequest;
        ...
        public Nutanix.Powershell.Models.ICategoryListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        /// <returns>
        /// an instance of GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder"
        /// /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder"
        /// /> cmdlet class.
        /// </summary>
        public GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder()
        {
        }
        ...
        internal GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _name = If( json?.PropertyT<Carbon.Json.JsonString>("Name"), out var __jsonName) ? (string)__jsonName : (string)Name;
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Nutanix.Powershell.Models.CategoryListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.ListCategoryValues(Name, GetEntitiesRequest, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetCategoryValue_CategoryValuesNameFilterKindLengthOffsetSortAttributeSortOrder" />
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Name,GetEntitiesRequest}));
            }
        }
