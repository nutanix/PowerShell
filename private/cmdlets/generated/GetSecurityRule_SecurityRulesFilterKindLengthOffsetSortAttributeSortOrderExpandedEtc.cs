namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-SecurityRule.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"SecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleListIntentResponse))]
    public class GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.INetworkSecurityRuleListMetadata _getEntitiesRequestBody= new Nutanix.Powershell.Models.NetworkSecurityRuleListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        private Nutanix.Powershell.Models.INetworkSecurityRuleListMetadata GetEntitiesRequestBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc"
        /// /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc"
        /// /> cmdlet class.
        /// </summary>
        public GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc()
        {
        }
        ...
        internal GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequestBody = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequestBody"), out var __jsonGetEntitiesRequestBody) ? Nutanix.Powershell.Models.NetworkSecurityRuleListMetadata.FromJson(__jsonGetEntitiesRequestBody) : GetEntitiesRequestBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'listSecurityRules' operation"))
                {
        ...
        {
            GetEntitiesRequestBody.Kind = "security_rule";
            using( NoSynchronizationContext )
            {
                ...
                if (Length == 0 && Offset == 0) {
                    await this.Client.ListAllSecurityRules(GetEntitiesRequestBody, onOKList, onDefault, this, Pipeline, Credential);
                } else {
                    await this.Client.ListSecurityRules(GetEntitiesRequestBody, onOK, onDefault, this, Pipeline, Credential);
                }
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetSecurityRule_SecurityRulesFilterKindLengthOffsetSortAttributeSortOrderExpandedEtc"
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.INetworkSecurityRuleListIntentResponse"
        /// /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.INetworkSecurityRuleListIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Nutanix.Powershell.Models.INetworkSecurityRuleListIntentResponse
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOKList(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.INetworkSecurityRuleIntentResource[]> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
