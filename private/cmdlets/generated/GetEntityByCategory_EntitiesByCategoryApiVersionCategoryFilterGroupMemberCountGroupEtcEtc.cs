namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-EntityByCategory.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"EntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryQueryResponse))]
    public class GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                QueryBody.CategoryFilter = QueryBody.CategoryFilter ?? new Nutanix.Powershell.Models.CategoryFilter();
                QueryBody.CategoryFilter.KindList = value;
            }
        }
        ...
        public System.Collections.Generic.IDictionary<string,string> CategoryFilterParams
        {
            ...
            {
                QueryBody.CategoryFilter = QueryBody.CategoryFilter ?? new Nutanix.Powershell.Models.CategoryFilter();
                QueryBody.CategoryFilter.Params = value;
            }
        }
        ...
        public string CategoryFilterType
        {
            ...
            {
                QueryBody.CategoryFilter = QueryBody.CategoryFilter ?? new Nutanix.Powershell.Models.CategoryFilter();
                QueryBody.CategoryFilter.Type = value;
            }
        }
        ...
        public long GroupMemberCount
        {
            set
            {
                QueryBody.GroupMemberCount = value;
            }
        }
        ...
        public long GroupMemberOffset
        {
            set
            {
                QueryBody.GroupMemberOffset = value;
            }
        }
        ...
        /// <summary>Backing field for <see cref="QueryBody" /> property.</summary>
        private Nutanix.Powershell.Models.ICategoryQueryInput _queryBody= new Nutanix.Powershell.Models.CategoryQueryInput();

        /// <summary>Categories query input object.</summary>
        private Nutanix.Powershell.Models.ICategoryQueryInput QueryBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc()
        {
        }
        ...
        internal GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _queryBody = If( json?.PropertyT<Carbon.Json.JsonObject>("QueryBody"), out var __jsonQueryBody) ? Nutanix.Powershell.Models.CategoryQueryInput.FromJson(__jsonQueryBody) : QueryBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'listEntitiesByCategory' operation"))
                {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetEntityByCategory_EntitiesByCategoryApiVersionCategoryFilterGroupMemberCountGroupEtcEtc"
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != QueryBody ? (Carbon.Json.JsonNode) QueryBody.ToJson(null) : null, "QueryBody" ,container.Add );
            return container;
        }
        /// <summary>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { QueryBody}));
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.ICategoryQueryResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryQueryResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Nutanix.Powershell.Models.ICategoryQueryResponse
