namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Invoke-SecurityNetwork.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"SecurityNetwork_Uuid")]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleIntentResponse))]
    public class InvokeSecurityNetwork_Uuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of InvokeSecurityNetwork_Uuid</returns>
        public Nutanix.Powershell.Cmdlets.InvokeSecurityNetwork_Uuid Clone()
        {
        ...
        /// <returns>an instance of InvokeSecurityNetwork_Uuid.</returns>
        public static Nutanix.Powershell.Cmdlets.InvokeSecurityNetwork_Uuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeSecurityNetwork_Uuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="InvokeSecurityNetwork_Uuid" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.InvokeSecurityNetwork_Uuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeSecurityNetwork_Uuid" /> cmdlet class.
        /// </summary>
        public InvokeSecurityNetwork_Uuid()
        {
        }
        ...
        internal InvokeSecurityNetwork_Uuid(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NetworkSecurityRules(Uuid, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeSecurityNetwork_Uuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
