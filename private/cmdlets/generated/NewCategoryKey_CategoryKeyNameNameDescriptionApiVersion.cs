namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"CategoryKey_CategoryKeyNameNameDescriptionApiVersion", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ICategoryKeyStatus))]
    public class NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ICategoryKey _spec;

        /// <summary>Category key definition.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Category key definition.", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.ICategoryKey Spec
        {
            get
            {
                return this._spec;
        ...
        /// <returns>a duplicate instance of NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion</returns>
        public Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion Clone()
        {
        ...
        /// <returns>an instance of NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion.</returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion" /> cmdlet class.
        /// </summary>
        public NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion()
        {
        }
        ...
        internal NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _name = If( json?.PropertyT<Carbon.Json.JsonString>("Name"), out var __jsonName) ? (string)__jsonName : (string)Name;
            _spec = If( json?.PropertyT<Carbon.Json.JsonObject>("Spec"), out var __jsonSpec) ? Nutanix.Powershell.Models.CategoryKey.FromJson(__jsonSpec) : Spec;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.CreateCategoryKey(Name, Spec, onOK, onCreated, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewCategoryKey_CategoryKeyNameNameDescriptionApiVersion" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Name,Spec}));
            }
        }
