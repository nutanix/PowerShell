namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-CategoryValue.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"CategoryValue_CategoryValueNameValue", SupportsShouldProcess = true)]
    public class RemoveCategoryValue_CategoryValueNameValue : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveCategoryValue_CategoryValueNameValue</returns>
        public Nutanix.Powershell.Cmdlets.RemoveCategoryValue_CategoryValueNameValue Clone()
        {
        ...
        /// <returns>an instance of RemoveCategoryValue_CategoryValueNameValue.</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveCategoryValue_CategoryValueNameValue FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveCategoryValue_CategoryValueNameValue(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveCategoryValue_CategoryValueNameValue" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.RemoveCategoryValue_CategoryValueNameValue FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'deleteCategoryValue' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.DeleteCategoryValue(Name, Value, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveCategoryValue_CategoryValueNameValue" /> cmdlet class.
        /// </summary>
        public RemoveCategoryValue_CategoryValueNameValue()
        {
        }
        ...
        internal RemoveCategoryValue_CategoryValueNameValue(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveCategoryValue_CategoryValueNameValue" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
