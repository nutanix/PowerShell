namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Poll_PollPollTimeoutSecondsTaskUuidList", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITaskPollResponse))]
    public class NewPoll_PollPollTimeoutSecondsTaskUuidList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.ITaskPollInput _body;

        /// <summary>Input for a task poll</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input for a task poll", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.ITaskPollInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>a duplicate instance of NewPoll_PollPollTimeoutSecondsTaskUuidList</returns>
        public Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidList Clone()
        {
        ...
        /// <returns>an instance of NewPoll_PollPollTimeoutSecondsTaskUuidList.</returns>
        public static Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewPoll_PollPollTimeoutSecondsTaskUuidList(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidList" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.NewPoll_PollPollTimeoutSecondsTaskUuidList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidList" /> cmdlet class.
        /// </summary>
        public NewPoll_PollPollTimeoutSecondsTaskUuidList()
        {
        }
        ...
        internal NewPoll_PollPollTimeoutSecondsTaskUuidList(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Nutanix.Powershell.Models.TaskPollInput.FromJson(__jsonBody) : Body;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NewPoll(Body, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewPoll_PollPollTimeoutSecondsTaskUuidList" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
