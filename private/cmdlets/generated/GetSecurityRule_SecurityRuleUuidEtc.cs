namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"SecurityRule_SecurityRuleUuidEtc")]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleIntentResponse))]
    public class GetSecurityRule_SecurityRuleUuidEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetSecurityRule_SecurityRuleUuidEtc</returns>
        public Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRuleUuidEtc Clone()
        {
        ...
        /// <returns>an instance of GetSecurityRule_SecurityRuleUuidEtc.</returns>
        public static Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRuleUuidEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetSecurityRule_SecurityRuleUuidEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetSecurityRule_SecurityRuleUuidEtc" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetSecurityRule_SecurityRuleUuidEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetSecurityRule_SecurityRuleUuidEtc" /> cmdlet class.
        /// </summary>
        public GetSecurityRule_SecurityRuleUuidEtc()
        {
        }
        ...
        internal GetSecurityRule_SecurityRuleUuidEtc(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetSecurityRule(Uuid, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetSecurityRule_SecurityRuleUuidEtc" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
