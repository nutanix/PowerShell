namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-Task.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Task_TaskUuid")]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITask))]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITaskStatus))]
    public class GetTask_TaskUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetTask_TaskUuid</returns>
        public Nutanix.Powershell.Cmdlets.GetTask_TaskUuid Clone()
        {
        ...
        /// <returns>an instance of GetTask_TaskUuid.</returns>
        public static Nutanix.Powershell.Cmdlets.GetTask_TaskUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetTask_TaskUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetTask_TaskUuid" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.GetTask_TaskUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>Intializes a new instance of the <see cref="GetTask_TaskUuid" /> cmdlet class.</summary>
        public GetTask_TaskUuid()
        {
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetTask(Uuid, onOK, onNotFound, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetTask_TaskUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onNotFound(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ITaskStatus> response)
        {
            using( NoSynchronizationContext )
            {
                // onNotFound - response for 404 / application/json
                // (await response) // should be Nutanix.Powershell.Models.ITaskStatus
                WriteObject(await response);
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.ITask" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.ITask> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Nutanix.Powershell.Models.ITask
                WriteObject(await response);
            }
        }
    }
